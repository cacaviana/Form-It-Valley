  ...
  <header class="bg-white border-b px-6 py-4 flex justify-between items-center">
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="text-sm text-gray-500">Formularios de qualificacao e reservas</p>
      </div>
    </div>
  ...
  <main class="max-w-6xl mx-auto p-6">
    ...
    {:else if tab === 'flows'}
      ...
      <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="bg-white rounded-lg border p-4">
          ...
          <p class="text-xs text-gray-500">Total de formularios</p>
        </div>
        <div class="bg-white rounded-lg border p-4">
        ...
        <div class="bg-white rounded-lg border p-4">
          ...
          <p class="text-xs text-gray-500">Total de reservas</p>
        </div>
      </div>
      ...
      {#if flows.length === 0}
        <div class="text-center py-12 bg-white rounded-lg border">
          ...
          <p class="text-gray-500 mb-3">Nenhum formulario de agendamento</p>
    ...
    {:else if tab === 'bookings'}
      {#if schedulings.length === 0}
        <div class="text-center py-12 bg-white rounded-lg border">
          <p class="text-gray-500">Nenhuma reserva</p>
        </div>
      {:else}
          ...
          <table class="w-full">
            <thead>
              <tr class="border-b bg-gray-50">
                ...
                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase">Formulario</th>
              </tr>
            </thead>
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                  ...
                  <td class="px-5 py-3">
                    <span class="text-xs px-2 py-0.5 rounded-full {bookingStatusColors[s.status] || 'bg-gray-100 text-gray-600'}">
                      {s.status === 'confirmed' ? 'Confirmado' : s.status === 'cancelled' ? 'Cancelado' : s.status === 'completed' ? 'Concluido' : s.status}
                    </span>
                  </td>
                  <td class="px-5 py-3">
